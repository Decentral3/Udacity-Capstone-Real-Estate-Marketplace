...
contract Ownable {
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        require(newOwner != address(0), "ERROR: ADDRESS IS NOT VALID");
        _owner = newOwner;
...
contract ERC721 is Pausable, ERC165 {
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(ownerOf(tokenId) != to, "ERROR:  THIS ADDRESS IS ALREADY THE OWNER OF THE TOKEN");
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == owner() || isApprovedForAll(owner(), msg.sender), "ERROR: NOT THE TOKEN OWNER");
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(!_exists(tokenId), "ERROR: TOKEN ALREADY EXISITS!");
    ...
    function _transferFrom(
        ...
        requre(address(to) != address(0), "ERROR: 'TO' ADDRESS IS NOT VALID");
        // TODO: clear approval
...
contract REITTOKEN is ERC721Metadata("REITToken", "RTK", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {
    function mint(address to, unit256 tokenId) public onlyOwner() returns (bool){
